  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          // Modal surface token `bg-dialog`: SOLID in both themes (white
          // light / neutral.800 dark) — a modal must never bleed the content
          // behind it through. Not `bg-card` (glass in both modes).
