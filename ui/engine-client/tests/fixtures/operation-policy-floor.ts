...
export const OPERATION_POLICY_FLOOR: Readonly<Record<string, OperationPolicy>> = {
  ...
  deleteFile: { group: "files", confirm: true, hidden: false, route: "DELETE /agents/{agentPath}/files", rawResponse: true },
  ...
  getContext: { group: "settings", confirm: false, hidden: false, route: null, rawResponse: null },
  ...
  joinAgentTeam: { group: "teams", confirm: true, hidden: false, route: "POST /v1/org/teams/{teamId}/join", rawResponse: false },
  ...
  moveProjectFile: { group: "files", confirm: true, hidden: false, route: "POST /agents/{agentPath}/files/move", rawResponse: true },
  ...
  renameFile: { group: "files", confirm: true, hidden: false, route: "POST /agents/{agentPath}/files/rename", rawResponse: true },
  ...
  saveAttachments: { group: "attachments", confirm: false, hidden: true, route: null, rawResponse: null },
  ...
  setContext: { group: "settings", confirm: true, hidden: false, route: null, rawResponse: null },
