...
// ---------------------------------------------------------------------------
//
// Mirrors `houston_engine_core::credentials::types::VerifiableCredential` +
// the request/response shapes for the credentials routes. Wire format is
// snake_case so a round-trip needs no transform.
