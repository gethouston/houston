...
- `missions.search`: the agent the client is rooted at is not a parameter
...
- `turns.cancel`: the agent the client is rooted at is not a parameter
- `turns.history`: the agent the client is rooted at is not a parameter
- `turns.observe`: the agent the client is rooted at is not a parameter
