    ...
    >
      ...
      <div className="flex shrink-0 items-center gap-1">
        ...
        <button
          ...
          className="inline-flex size-7 shrink-0 items-center justify-center rounded-lg text-ink-muted transition-colors hover:bg-ink/[0.05] hover:text-danger"
        >
...
function SkillImageBox({
  ...
  return (
    <span className="flex size-8 shrink-0 items-center justify-center overflow-hidden rounded-lg bg-input">
      {showImage ? (
        <img
          src={imageUrl}
          alt=""
