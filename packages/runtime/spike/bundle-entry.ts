...
import { loginOpenAICodexDeviceCode, loginAnthropic } from "@earendil-works/pi-ai/oauth";

// Reference everything so nothing is dropped as "unused import".
export const used = {
  createAgentSession, AuthStorage, ModelRegistry, SessionManager,
  DefaultResourceLoader, registerFauxProvider, getModel,
  loginOpenAICodexDeviceCode, loginAnthropic,
};
