 ...
 * `anthropic` provider offers it and a turn can run on it.
 *
 ...
 *
 * Idempotent: a no-op once pi-ai serves claude-opus-5 natively. The host has a
 * twin (packages/host/src/providers/opus-5-catalog-patch.ts) because host and
