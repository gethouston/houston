 ...
 * `GET /v1/catalog` advertises it and the picker can offer it. Fable 5.1
 ...
 * ($0.25/MTok, down from $1). Idempotent. The runtime has a twin
 * (packages/runtime/src/ai/fable-5-1-catalog-patch.ts) — DELETE BOTH when a pi
