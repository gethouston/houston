...
/**
 * Backport Kimi K3 into pi-ai 0.80.6's baked Moonshot AI catalog, so
 ...
 *
 * Idempotent: a no-op once pi-ai serves kimi-k3 natively. The runtime has a
 * twin (packages/runtime/src/ai/moonshot-k3-catalog-patch.ts) because host and
