...
const out = `// GENERATED by scripts/generate-hub-catalog.mjs — do not edit by hand.
...
export const HUB_CATALOG_DATA: Toolkit[] = ${JSON.stringify(entries, null, 1)};
`;

const target = join(
  dirname(fileURLToPath(import.meta.url)),
  "..",
  "packages/host/src/integrations/mcp/hub-catalog-data.ts",
);
