...
// — an override for a backported model (openai-codex / azure gpt-6-astra) is
// not drift. Delete with the pi bump that ships it natively.
await import("../../packages/host/src/providers/gpt-6-astra-catalog-patch.ts");
