...
/**
 * The Routines section's chat surface: the selected routine's chat, rendered
 * into the shell-level panel (`panelContainer`). Intake runs the create cards
 * over an empty chat surface; a routine/draft continues its real conversation.
 * Split out from the section itself so both stay under the size cap — this owns
