...
export default function (eleventyConfig) {
  ...
  // Landing-page enhancement assets: vendored Motion One, the scripted hero
  // demo, the animated mesh-gradient background, and spring micro-interactions.
  // Served verbatim from /assets/** — no bundler, no runtime CDN dependency.
